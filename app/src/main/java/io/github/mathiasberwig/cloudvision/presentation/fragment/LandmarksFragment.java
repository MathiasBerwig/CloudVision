...
public class LandmarksFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(landmarkInfo == null ?
                R.layout.fragment_landmarks_empty : R.layout.fragment_landmarks, container, false);
    }
    ...
    private void findInfoViews(View v) {
        txtLandmarkName = (TextView) v.findViewById(R.id.txt_landmark_name);
        txtLandmarkDescription = (TextView) v.findViewById(R.id.txt_landmark_description);
